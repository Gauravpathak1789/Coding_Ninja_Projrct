...
# -----------------------------
# Updated Prompt Template (from your tested snippet)
# -----------------------------
prompt_template = """
You are a helpful assistant designed to answer questions about a YouTube video link that have been provided based on its transcript.
...
# -----------------------------
# Updated Transcript Fetcher (from your tested snippet)
# -----------------------------
...
# -----------------------------
# Updated YouTube QA Tool (using your tested snippet)
# -----------------------------
@tool
def youtube_qa(video_url: str, question: str):
    ...
    try:
        ...
        answer = rag_runnable.invoke({"context": transcript, "question": question}).content
        return answer
...
class VideoAnalysisAgent:
    ...
    def process(self, query: str, video_url: str = None) -> str:
        ...
        if video_url:
            # Direct video analysis using the updated youtube_qa tool
...
if __name__ == "__main__":
    ...
    # Example queries
    test_queries = [
        "Summarize this video https://www.youtube.com/watch?v=woSrgDozmL4 and explain the key concepts"
    ]
